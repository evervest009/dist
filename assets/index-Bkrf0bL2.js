import{q as _,u as O,v as R,i as d,r as y,a as h,x as l,O as a,f as j}from"./index-CiJrowLK.js";import{n as v,c as f,o as P,r as T}from"./if-defined-BbmCEQdC.js";import{e as U,n as L}from"./index-4rjcNGKX.js";const u=_({isLegalCheckboxChecked:!1}),g={state:u,subscribe(i){return R(u,()=>i(u))},subscribeKey(i,e){return O(u,i,e)},setIsLegalCheckboxChecked(i){u.isLegalCheckboxChecked=i}},E=d`
  label {
    display: flex;
    align-items: center;
    cursor: pointer;
...
`;var k=function(i,e,r,n){var o=arguments.length,t=o<3?e:n===null?n=Object.getOwnPropertyDescriptor(e,r):n,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")t=Reflect.decorate(i,e,r,n);else for(var c=i.length-1;c>=0;c--)(s=i[c])&&(t=(o<3?s(t):o>3?s(e,r,t):s(e,r))||t);return o>3&&t&&Object.defineProperty(e,r,t),t};let p=class extends h{constructor(){super(...arguments),this.inputElementRef=U(),this.checked=void 0}render(){return l`
      <label>
        <input
    ...
    `}dispatchChangeEvent(){var e;this.dispatchEvent(new CustomEvent("checkboxChange",{detail:(e=this.inputElementRef.value)==null?void 0:e.checked,bubbles:!0,composed:!0}))}};p.styles=[y,E];k([v({type:Boolean})],p.prototype,"checked",void 0);p=k([f("wui-checkbox")],p);const W=d`
  :host {
    display: flex;
    align-items: center;
    justify-content: center;
...
`;var z=function(i,e,r,n){var o=arguments.length,t=o<3?e:n===null?n=Object.getOwnPropertyDescriptor(e,r):n,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")t=Reflect.decorate(i,e,r,n);else for(var c=i.length-1;c>=0;c--)(s=i[c])&&(t=(o<3?s(t):o>3?s(e,r,t):s(e,r))||t);return o>3&&t&&Object.defineProperty(e,r,t),t};let x=class extends h{render(){return l`
    ...
    `}};x.styles=[y,j,B];x=z([f("wui-ux-by-reown")],x);const D=d`
  :host > wui-flex {
...
`;var S=function(i,e,r,n){var o=arguments.length,t=o<3?e:n===null?n=Object.getOwnPropertyDescriptor(e,r):n,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")t=Reflect.decorate(i,e,r,n);else for(var c=i.length-1;c>=0;c--)(s=i[c])&&(t=(o<3?s(t):o>3?s(e,r,t):s(e,r))||t);return o>3&&t&&Object.defineProperty(e,r,t),t};let m=class extends h{render(){var o;const{termsConditionsUrl:e,privacyPolicyUrl:r}=a.state,n=(o=a.state.features)==null?void 0:o.legalCheckbox;return!e&&!r||n?null:l`
    ...
    `}andTemplate(){const{termsConditionsUrl:e,privacyPolicyUrl:r}=a.state;return e&&r?"and":""}termsTemplate(){const{termsConditionsUrl:e}=a.state;return e?l`<a href=${e}>Terms of Service</a>`:null}privacyTemplate(){const{privacyPolicyUrl:e}=a.state;return e?l`<a href=${e}>Privacy Policy</a>`:null}};m.styles=[D];m=S([f("w3m-legal-footer")],m);const I=d`
  :host {
    display: block;
