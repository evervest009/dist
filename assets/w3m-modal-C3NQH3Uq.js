import{i as g,r as B,a as v,x as c,s as O,f as te,G as oe,R as l,j as w,p as U,F as ie,m as D,k as ne,e as q,K,M as h,O as A,C as z,A as F,S as $,y as W,T as ae,Q as se,d as re,c as ce}from"./index-CiJrowLK.js";import{c as y,n as p,r as d,o as H,U as le}from"./if-defined-BbmCEQdC.js";import"./index-CigZEm4w.js";import"./index-CzjH7EJg.js";import"./index-dbsvV7Pd.js";import"./index-DPe2R_6J.js";import"./index-NxB4Zo_f.js";import"./index-DtyNp5Of.js";const de=g`
  :host {
    display: block;
...
`;var T=function(s,e,t,i){var n=arguments.length,o=n<3?e:i===null?i=Object.getOwnPropertyDescriptor(e,t):i,a;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")o=Reflect.decorate(s,e,t,i);else for(var r=s.length-1;r>=0;r--)(a=s[r])&&(o=(n<3?a(o):n>3?a(e,t,o):a(e,t))||o);return n>3&&o&&Object.defineProperty(e,t,o),o};let k=class extends v{constructor(){super(...arguments),this.message="",this.backgroundColor="accent-100",this.iconColor="accent-100",this.icon="info"}render(){return this.style.cssText=`
   ...
   `,c`
    ...
    `}onClose(){O.close()}};k.styles=[B,pe];T([p()],k.prototype,"message",void 0);T([p()],k.prototype,"backgroundColor",void 0);T([p()],k.prototype,"iconColor",void 0);T([p()],k.prototype,"icon",void 0);k=T([y("wui-alertbar")],k);const he=g`
  :host {
    display: block;
    position: absolute;
...
`;var J=function(s,e,t,i){var n=arguments.length,o=n<3?e:i===null?i=Object.getOwnPropertyDescriptor(e,t):i,a;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")o=Reflect.decorate(s,e,t,i);else for(var r=s.length-1;r>=0;r--)(a=s[r])&&(o=(n<3?a(o):n>3?a(e,t,o):a(e,t))||o);return n>3&&o&&Object.defineProperty(e,t,o),o};const we={info:{backgroundColor:"fg-350",iconColor:"fg-325",icon:"info"},success:{backgroundColor:"success-glass-reown-020",iconColor:"success-125",icon:"checkmark"},warning:{backgroundColor:"warning-glass-reown-020",iconColor:"warning-100",icon:"warningCircle"},error:{backgroundColor:"error-glass-reown-020",iconColor:"error-125",icon:"exclamationTriangle"}};let R=class extends v{constructor(){super(),this.unsubscribe=[],this.open=O.state.open,this.onOpen(!0),this.unsubscribe.push(O.subscribeKey("open",e=>{this.open=e,this.onOpen(!1)}))}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}render(){const{message:e,variant:t}=O.state,i=we[t];return c`
      ...
      ></wui-alertbar>
    `}onOpen(e){this.open?(this.animate([{opacity:0,transform:"scale(0.85)"},{opacity:1,transform:"scale(1)"}],{duration:150,fill:"forwards",easing:"ease"}),this.style.cssText="pointer-events: auto"):e||(this.animate([{opacity:1,transform:"scale(1)"},{opacity:0,transform:"scale(0.85)"}],{duration:150,fill:"forwards",easing:"ease"}),this.style.cssText="pointer-events: none")}};R.styles=he;J([d()],R.prototype,"open",void 0);R=J([y("w3m-alertbar")],R);const me=g`
  button {
    display: block;
    display: flex;
    align-items: center;
...
`;var m=function(s,e,t,i){var n=arguments.length,o=n<3?e:i===null?i=Object.getOwnPropertyDescriptor(e,t):i,a;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")o=Reflect.decorate(s,e,t,i);else for(var r=s.length-1;r>=0;r--)(a=s[r])&&(o=(n<3?a(o):n>3?a(e,t,o):a(e,t))||o);return n>3&&o&&Object.defineProperty(e,t,o),o};const be=["SmartSessionList"];function L(){var a,r,N,C,E,P,j;const s=(r=(a=l.state.data)==null?void 0:a.connector)==null?void 0:r.name,e=(C=(N=l.state.data)==null?void 0:N.wallet)==null?void 0:C.name,t=(P=(E=l.state.data)==null?void 0:E.network)==null?void 0:P.name,i=e??s,n=z.getConnectors();return{Connect:`Connect ${n.length===1&&((j=n[0])==null?void 0:j.id)==="w3m-email"?"Email":""} Wallet`,Create:"Create Wallet",ChooseAccountName:void 0,Account:void 0,AccountSettings:void 0,AllWallets:"All Wallets",ApproveTransaction:"Approve Transaction",BuyInProgress:"Buy",ConnectingExternal:i??"Connect Wallet",ConnectingWalletConnect:i??"WalletConnect",ConnectingWalletConnectBasic:"WalletConnect",ConnectingSiwe:"Sign In",Convert:"Convert",ConvertSelectToken:"Select token",ConvertPreview:"Preview convert",Downloads:i?`Get ${i}`:"Downloads",EmailLogin:"Email Login",EmailVerifyOtp:"Confirm Email",EmailVerifyDevice:"Register Device",GetWallet:"Get a wallet",Networks:"Choose Network",OnRampProviders:"Choose Provider",OnRampActivity:"Activity",OnRampTokenSelect:"Select Token",OnRampFiatSelect:"Select Currency",Profile:void 0,SwitchNetwork:t??"Switch Network",SwitchAddress:"Switch Address",Transactions:"Activity",UnsupportedChain:"Switch Network",UpgradeEmailWallet:"Upgrade your Wallet",UpdateEmailWallet:"Edit Email",UpdateEmailPrimaryOtp:"Confirm Current Email",UpdateEmailSecondaryOtp:"Confirm New Email",WhatIsABuy:"What is Buy?",RegisterAccountName:"Choose name",RegisterAccountNameSuccess:"",WalletReceive:"Receive",WalletCompatibleNetworks:"Compatible Networks",Swap:"Swap",SwapSelectToken:"Select token",SwapPreview:"Preview swap",WalletSend:"Send",WalletSendPreview:"Review send",WalletSendSelectToken:"Select Token",WhatIsANetwork:"What is a network?",WhatIsAWallet:"What is a wallet?",ConnectWallets:"Connect wallet",ConnectSocials:"All socials",ConnectingSocial:F.state.socialProvider?F.state.socialProvider:"Connect Social",ConnectingMultiChain:"Select chain",ConnectingFarcaster:"Farcaster",SwitchActiveChain:"Switch chain",SmartSessionCreated:void 0,SmartSessionList:"Smart Sessions",SIWXSignMessage:"Sign In"}}let u=class extends v{constructor(){super(),this.unsubscribe=[],this.heading=L()[l.state.view],this.network=w.state.activeCaipNetwork,this.networkImage=U.getNetworkImage(this.network),this.buffering=!1,this.showBack=!1,this.prevHistoryLength=1,this.view=l.state.view,this.viewDirection="",this.headerText=L()[l.state.view],this.unsubscribe.push(ie.subscribeNetworkImages(()=>{this.networkImage=U.getNetworkImage(this.network)}),l.subscribeKey("view",e=>{setTimeout(()=>{this.view=e,this.headerText=L()[e]},D.ANIMATION_DURATIONS.HeaderText),this.onViewChange(),this.onHistoryChange()}),ne.subscribeKey("buffering",e=>this.buffering=e),w.subscribeKey("activeCaipNetwork",e=>{this.network=e,this.networkImage=U.getNetworkImage(this.network)}))}disconnectCallback(){this.unsubscribe.forEach(e=>e())}render(){return c`
    ...
    `}leftHeaderTemplate(){var C;const{view:e}=l.state,t=e==="Connect",i=A.state.enableEmbedded,n=e==="ApproveTransaction",o=e==="ConnectingSiwe",a=e==="Account",r=A.state.enableNetworkSwitch,N=n||o||t&&i;return a&&r?c`<wui-select
        id="dynamic"
        data-testid="w3m-account-select-network"
        active-network=${H((C=this.network)==null?void 0:C.name)}
        @click=${this.onNetworks.bind(this)}
        imageSrc=${H(this.networkImage)}
      ></wui-select>`:this.showBack&&!N?c`<wui-icon-link
...
`;var ee=function(s,e,t,i){var n=arguments.length,o=n<3?e:i===null?i=Object.getOwnPropertyDescriptor(e,t):i,a;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")o=Reflect.decorate(s,e,t,i);else for(var r=s.length-1;r>=0;r--)(a=s[r])&&(o=(n<3?a(o):n>3?a(e,t,o):a(e,t))||o);return n>3&&o&&Object.defineProperty(e,t,o),o};const ye={loading:void 0,success:{backgroundColor:"success-100",iconColor:"success-100",icon:"checkmark"},error:{backgroundColor:"error-100",iconColor:"error-100",icon:"close"}};let _=class extends v{constructor(){super(),this.unsubscribe=[],this.timeout=void 0,this.open=$.state.open,this.unsubscribe.push($.subscribeKey("open",e=>{this.open=e,this.onOpen()}))}disconnectedCallback(){clearTimeout(this.timeout),this.unsubscribe.forEach(e=>e())}render(){const{message:e,variant:t,svg:i}=$.state,n=ye[t],{icon:o,iconColor:a}=i??n??{};return c`
      <wui-snackbar
        ...
        .loading=${t==="loading"}
      ></wui-snackbar>
    `}onOpen(){clearTimeout(this.timeout),this.open?(this.animate([{opacity:0,transform:"translateX(-50%) scale(0.85)"},{opacity:1,transform:"translateX(-50%) scale(1)"}],{duration:150,fill:"forwards",easing:"ease"}),this.timeout&&clearTimeout(this.timeout),$.state.autoClose&&(this.timeout=setTimeout(()=>$.hide(),2500))):this.animate([{opacity:1,transform:"translateX(-50%) scale(1)"},{opacity:0,transform:"translateX(-50%) scale(0.85)"}],{duration:150,fill:"forwards",easing:"ease"})}};_.styles=ve;ee([d()],_.prototype,"open",void 0);_=ee([y("w3m-snackbar")],_);const Ce=g`
  :host {
...
`;var S=function(s,e,t,i){var n=arguments.length,o=n<3?e:i===null?i=Object.getOwnPropertyDescriptor(e,t):i,a;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")o=Reflect.decorate(s,e,t,i);else for(var r=s.length-1;r>=0;r--)(a=s[r])&&(o=(n<3?a(o):n>3?a(e,t,o):a(e,t))||o);return n>3&&o&&Object.defineProperty(e,t,o),o};const Q="scroll-lock";let b=class extends v{constructor(){super(),this.unsubscribe=[],this.abortController=void 0,this.hasPrefetched=!1,this.enableEmbedded=A.state.enableEmbedded,this.open=h.state.open,this.caipAddress=w.state.activeCaipAddress,this.caipNetwork=w.state.activeCaipNetwork,this.shake=h.state.shake,this.filterByNamespace=z.state.filterByNamespace,this.initializeTheming(),W.prefetchAnalyticsConfig(),this.unsubscribe.push(h.subscribeKey("open",e=>e?this.onOpen():this.onClose()),h.subscribeKey("shake",e=>this.shake=e),w.subscribeKey("activeCaipNetwork",e=>this.onNewNetwork(e)),w.subscribeKey("activeCaipAddress",e=>this.onNewAddress(e)),A.subscribeKey("enableEmbedded",e=>this.enableEmbedded=e),z.subscribeKey("filterByNamespace",e=>{var t;this.filterByNamespace!==e&&!((t=w.getAccountData(e))!=null&&t.caipAddress)&&(W.fetchRecommendedWallets(),this.filterByNamespace=e)}))}firstUpdated(){if(this.caipAddress){if(this.enableEmbedded){h.close(),this.prefetch();return}this.onNewAddress(this.caipAddress)}this.open&&this.onOpen(),this.enableEmbedded&&this.prefetch()}disconnectedCallback(){this.unsubscribe.forEach(e=>e()),this.onRemoveKeyboardListener()}render(){return this.style.cssText=`
    ...
    `,document.head.appendChild(e)}onScrollUnlock(){const e=document.head.querySelector(`style[data-w3m="${Q}"]`);e&&e.remove()}onAddKeyboardListener(){var t;this.abortController=new AbortController;const e=(t=this.shadowRoot)==null?void 0:t.querySelector("wui-card");e==null||e.focus(),window.addEventListener("keydown",i=>{if(i.key==="Escape")this.handleClose();else if(i.key==="Tab"){const{tagName:n}=i.target;n&&!n.includes("W3M-")&&!n.includes("WUI-")&&(e==null||e.focus())}},this.abortController)}onRemoveKeyboardListener(){var e;(e=this.abortController)==null||e.abort(),this.abortController=void 0}async onNewAddress(e){const t=w.state.isSwitchingNamespace,i=re.getPlainAddress(e);!i&&!t?h.close():t&&i&&l.goBack(),await K.initializeIfEnabled(),this.caipAddress=e,w.setIsSwitchingNamespace(!1)}onNewNetwork(e){var Y,V,G,X;const t=(V=(Y=this.caipNetwork)==null?void 0:Y.caipNetworkId)==null?void 0:V.toString(),i=(G=e==null?void 0:e.caipNetworkId)==null?void 0:G.toString(),n=t&&i&&t!==i,o=w.state.isSwitchingNamespace,a=((X=this.caipNetwork)==null?void 0:X.name)===ce.UNSUPPORTED_NETWORK_NAME,r=l.state.view==="ConnectingExternal",N=!this.caipAddress,C=n&&!a&&!o,E=l.state.view==="UnsupportedChain";h.state.open&&!r&&(N||E||C)&&l.goBack(),this.caipNetwork=e}prefetch(){this.hasPrefetched||(W.prefetch(),W.fetchWallets({page:1}),this.hasPrefetched=!0)}};b.styles=Ce;S([p({type:Boolean})],b.prototype,"enableEmbedded",void 0);S([d()],b.prototype,"open",void 0);S([d()],b.prototype,"caipAddress",void 0);S([d()],b.prototype,"caipNetwork",void 0);S([d()],b.prototype,"shake",void 0);S([d()],b.prototype,"filterByNamespace",void 0);b=S([y("w3m-modal")],b);export{b as W3mModal};
