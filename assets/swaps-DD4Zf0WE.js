import{i as P,a as U,j as _,N as D,x as u,b as V,e as W,R as $,d as M,M as K,A as B,W as F,r as Q,f as q}from"./index-CiJrowLK.js";import{r as s,n as w,c as C,U as x}from"./if-defined-BbmCEQdC.js";import"./index-4rjcNGKX.js";import{M as R}from"./index-BgzLijAE.js";import"./index-NxB4Zo_f.js";import{S as n}from"./index-Dc8uoY4v.js";import"./index-BRy0hHu6.js";import"./index-D0_7U1w6.js";import"./index-CzjH7EJg.js";import"./index-DPe2R_6J.js";import"./index-dbsvV7Pd.js";const G={numericInputKeyDown(l,t,e){const i=["Backspace","Meta","Ctrl","a","A","c","C","x","X","v","V","ArrowLeft","ArrowRight","Tab"],r=l.metaKey||l.ctrlKey,o=l.key,a=o.toLocaleLowerCase(),c=a==="a",y=a==="c",k=a==="v",j=a==="x",E=o===",",N=o===".",L=o>="0"&&o<="9";!r&&(c||y||k||j)&&l.preventDefault(),t==="0"&&!E&&!N&&o==="0"&&l.preventDefault(),t==="0"&&L&&(e(o),l.preventDefault()),(E||N)&&(t||(e("0."),l.preventDefault()),(t!=null&&t.includes(".")||t!=null&&t.includes(","))&&l.preventDefault()),!L&&!i.includes(o)&&!N&&!E&&l.preventDefault()}},H=P`
  :host {
    width: 100%;
  }
...
`;var b=function(l,t,e,i){var r=arguments.length,o=r<3?t:i===null?i=Object.getOwnPropertyDescriptor(t,e):i,a;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")o=Reflect.decorate(l,t,e,i);else for(var c=l.length-1;c>=0;c--)(a=l[c])&&(o=(r<3?a(o):r>3?a(t,e,o):a(t,e))||o);return r>3&&o&&Object.defineProperty(t,e,o),o};const X=V.CONVERT_SLIPPAGE_TOLERANCE;let f=class extends U{constructor(){var t;super(),this.unsubscribe=[],this.networkName=(t=_.state.activeCaipNetwork)==null?void 0:t.name,this.detailsOpen=!1,this.sourceToken=n.state.sourceToken,this.toToken=n.state.toToken,this.toTokenAmount=n.state.toTokenAmount,this.sourceTokenPriceInUSD=n.state.sourceTokenPriceInUSD,this.toTokenPriceInUSD=n.state.toTokenPriceInUSD,this.priceImpact=n.state.priceImpact,this.maxSlippage=n.state.maxSlippage,this.networkTokenSymbol=n.state.networkTokenSymbol,this.inputError=n.state.inputError,this.unsubscribe.push(n.subscribe(e=>{this.sourceToken=e.sourceToken,this.toToken=e.toToken,this.toTokenAmount=e.toTokenAmount,this.priceImpact=e.priceImpact,this.maxSlippage=e.maxSlippage,this.sourceTokenPriceInUSD=e.sourceTokenPriceInUSD,this.toTokenPriceInUSD=e.toTokenPriceInUSD,this.inputError=e.inputError}))}render(){const t=this.toTokenAmount&&this.maxSlippage?D.bigNumber(this.toTokenAmount).minus(this.maxSlippage).toString():null;if(!this.sourceToken||!this.toToken||this.inputError)return null;const e=this.sourceTokenPriceInUSD&&this.toTokenPriceInUSD?1/this.toTokenPriceInUSD*this.sourceTokenPriceInUSD:0;return u`
    ...
    `}toggleDetails(){this.detailsOpen=!this.detailsOpen}};f.styles=[H];b([s()],f.prototype,"networkName",void 0);b([w()],f.prototype,"detailsOpen",void 0);b([s()],f.prototype,"sourceToken",void 0);b([s()],f.prototype,"toToken",void 0);b([s()],f.prototype,"toTokenAmount",void 0);b([s()],f.prototype,"sourceTokenPriceInUSD",void 0);b([s()],f.prototype,"toTokenPriceInUSD",void 0);b([s()],f.prototype,"priceImpact",void 0);b([s()],f.prototype,"maxSlippage",void 0);b([s()],f.prototype,"networkTokenSymbol",void 0);b([s()],f.prototype,"inputError",void 0);f=b([C("w3m-swap-details")],f);const Y=P`
  :host {
    width: 100%;
  }
...
`;var z=function(l,t,e,i){var r=arguments.length,o=r<3?t:i===null?i=Object.getOwnPropertyDescriptor(t,e):i,a;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")o=Reflect.decorate(l,t,e,i);else for(var c=l.length-1;c>=0;c--)(a=l[c])&&(o=(r<3?a(o):r>3?a(t,e,o):a(t,e))||o);return r>3&&o&&Object.defineProperty(t,e,o),o};let O=class extends U{constructor(){super(...arguments),this.target="sourceToken"}render(){return u`
    ...
    `}};O.styles=[Y];z([w()],O.prototype,"target",void 0);O=z([C("w3m-swap-input-skeleton")],O);const Z=P`
  :host > wui-flex {
    display: flex;
    flex-direction: row;
    justify-content: space-between;
...
`;var g=function(l,t,e,i){var r=arguments.length,o=r<3?t:i===null?i=Object.getOwnPropertyDescriptor(t,e):i,a;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")o=Reflect.decorate(l,t,e,i);else for(var c=l.length-1;c>=0;c--)(a=l[c])&&(o=(r<3?a(o):r>3?a(t,e,o):a(t,e))||o);return r>3&&o&&Object.defineProperty(t,e,o),o};let d=class extends U{constructor(){var t;super(),this.unsubscribe=[],this.detailsOpen=!1,this.caipNetworkId=(t=_.state.activeCaipNetwork)==null?void 0:t.caipNetworkId,this.initialized=n.state.initialized,this.loadingQuote=n.state.loadingQuote,this.loadingPrices=n.state.loadingPrices,this.loadingTransaction=n.state.loadingTransaction,this.sourceToken=n.state.sourceToken,this.sourceTokenAmount=n.state.sourceTokenAmount,this.sourceTokenPriceInUSD=n.state.sourceTokenPriceInUSD,this.toToken=n.state.toToken,this.toTokenAmount=n.state.toTokenAmount,this.toTokenPriceInUSD=n.state.toTokenPriceInUSD,this.inputError=n.state.inputError,this.gasPriceInUSD=n.state.gasPriceInUSD,this.fetchError=n.state.fetchError,this.onDebouncedGetSwapCalldata=M.debounce(async()=>{await n.swapTokens()},200),_.subscribeKey("activeCaipNetwork",e=>{this.caipNetworkId!==(e==null?void 0:e.caipNetworkId)&&(this.caipNetworkId=e==null?void 0:e.caipNetworkId,n.resetState(),n.initializeState())}),this.unsubscribe.push(K.subscribeKey("open",e=>{e||n.resetState()}),$.subscribeKey("view",e=>{e.includes("Swap")||n.resetValues()}),n.subscribe(e=>{this.initialized=e.initialized,this.loadingQuote=e.loadingQuote,this.loadingPrices=e.loadingPrices,this.loadingTransaction=e.loadingTransaction,this.sourceToken=e.sourceToken,this.sourceTokenAmount=e.sourceTokenAmount,this.sourceTokenPriceInUSD=e.sourceTokenPriceInUSD,this.toToken=e.toToken,this.toTokenAmount=e.toTokenAmount,this.toTokenPriceInUSD=e.toTokenPriceInUSD,this.inputError=e.inputError,this.gasPriceInUSD=e.gasPriceInUSD,this.fetchError=e.fetchError}))}firstUpdated(){n.initializeState(),this.watchTokensAndValues()}disconnectedCallback(){this.unsubscribe.forEach(t=>t==null?void 0:t()),clearInterval(this.interval)}render(){return u`
    ...
    `}templateTokenInput(t,e){var c,y;const i=(c=n.state.myTokensWithBalance)==null?void 0:c.find(k=>(k==null?void 0:k.address)===(e==null?void 0:e.address)),r=t==="toToken"?this.toTokenAmount:this.sourceTokenAmount,o=t==="toToken"?this.toTokenPriceInUSD:this.sourceTokenPriceInUSD,a=D.parseLocalStringToNumber(r)*o;return u`<w3m-swap-input
    ...
    ></w3m-swap-input>`}onSetMaxValue(t,e){const i=t==="sourceToken"?this.sourceToken:this.toToken,r=(i==null?void 0:i.address)===_.getActiveNetworkTokenAddress();let o="0";if(!e){o="0",this.handleChangeAmount(t,o);return}if(!this.gasPriceInUSD){o=e,this.handleChangeAmount(t,o);return}const a=D.bigNumber(this.gasPriceInUSD.toFixed(5)).div(this.sourceTokenPriceInUSD),c=r?D.bigNumber(e).minus(a):D.bigNumber(e);this.handleChangeAmount(t,c.gt(0)?c.toFixed(20):"0")}templateDetails(){return!this.sourceToken||!this.toToken||this.inputError?null:u`<w3m-swap-details .detailsOpen=${this.detailsOpen}></w3m-swap-details>`}handleChangeAmount(t,e){n.clearError(),t==="sourceToken"?n.setSourceTokenAmount(e):n.setToTokenAmount(e),this.onDebouncedGetSwapCalldata()}templateActionButton(){const t=!this.toToken||!this.sourceToken,e=!this.sourceTokenAmount,i=this.loadingQuote||this.loadingPrices||this.loadingTransaction,r=i||t||e||this.inputError;return u` <wui-flex gap="xs">
      <wui-button
    ...
    </wui-flex>`}onSwitchTokens(){n.switchTokens()}async onSwapPreview(){var t,e;this.fetchError&&await n.swapTokens(),W.sendEvent({type:"track",event:"INITIATE_SWAP",properties:{network:this.caipNetworkId||"",swapFromToken:((t=this.sourceToken)==null?void 0:t.symbol)||"",swapToToken:((e=this.toToken)==null?void 0:e.symbol)||"",swapFromAmount:this.sourceTokenAmount||"",swapToAmount:this.toTokenAmount||"",isSmartAccount:B.state.preferredAccountType===F.ACCOUNT_TYPES.SMART_ACCOUNT}}),$.push("SwapPreview")}};d.styles=tt;g([s()],d.prototype,"interval",void 0);g([s()],d.prototype,"detailsOpen",void 0);g([s()],d.prototype,"caipNetworkId",void 0);g([s()],d.prototype,"initialized",void 0);g([s()],d.prototype,"loadingQuote",void 0);g([s()],d.prototype,"loadingPrices",void 0);g([s()],d.prototype,"loadingTransaction",void 0);g([s()],d.prototype,"sourceToken",void 0);g([s()],d.prototype,"sourceTokenAmount",void 0);g([s()],d.prototype,"sourceTokenPriceInUSD",void 0);g([s()],d.prototype,"toToken",void 0);g([s()],d.prototype,"toTokenAmount",void 0);g([s()],d.prototype,"toTokenPriceInUSD",void 0);g([s()],d.prototype,"inputError",void 0);g([s()],d.prototype,"gasPriceInUSD",void 0);g([s()],d.prototype,"fetchError",void 0);d=g([C("w3m-swap-view")],d);const et=P`
  :host > wui-flex:first-child {
    overflow-y: auto;
    overflow-x: hidden;
    scrollbar-width: none;
...
`;var A=function(l,t,e,i){var r=arguments.length,o=r<3?t:i===null?i=Object.getOwnPropertyDescriptor(t,e):i,a;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")o=Reflect.decorate(l,t,e,i);else for(var c=l.length-1;c>=0;c--)(a=l[c])&&(o=(r<3?a(o):r>3?a(t,e,o):a(t,e))||o);return r>3&&o&&Object.defineProperty(t,e,o),o};let S=class extends U{constructor(){super(),this.observer=new IntersectionObserver(()=>{}),this.imageSrc=void 0,this.name=void 0,this.symbol=void 0,this.price=void 0,this.amount=void 0,this.visible=!1,this.imageError=!1,this.observer=new IntersectionObserver(t=>{t.forEach(e=>{e.isIntersecting?this.visible=!0:this.visible=!1})},{threshold:.1})}firstUpdated(){this.observer.observe(this)}disconnectedCallback(){this.observer.disconnect()}render(){var e;if(!this.visible)return null;const t=this.amount&&this.price?(e=D.multiply(this.price,this.amount))==null?void 0:e.toFixed(3):null;return u`
    ...
    `}visualTemplate(){return this.imageError?u`<wui-flex class="token-item-image-placeholder">
      ...
      ></wui-image>`:null}imageLoadError(){this.imageError=!0}};S.styles=[Q,q,ot];A([w()],S.prototype,"imageSrc",void 0);A([w()],S.prototype,"name",void 0);A([w()],S.prototype,"symbol",void 0);A([w()],S.prototype,"price",void 0);A([w()],S.prototype,"amount",void 0);A([s()],S.prototype,"visible",void 0);A([s()],S.prototype,"imageError",void 0);S=A([C("wui-token-list-item")],S);const it=P`
  :host {
...
`;var I=function(l,t,e,i){var r=arguments.length,o=r<3?t:i===null?i=Object.getOwnPropertyDescriptor(t,e):i,a;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")o=Reflect.decorate(l,t,e,i);else for(var c=l.length-1;c>=0;c--)(a=l[c])&&(o=(r<3?a(o):r>3?a(t,e,o):a(t,e))||o);return r>3&&o&&Object.defineProperty(t,e,o),o};let v=class extends U{constructor(){var t;super(),this.unsubscribe=[],this.targetToken=(t=$.state.data)==null?void 0:t.target,this.sourceToken=n.state.sourceToken,this.sourceTokenAmount=n.state.sourceTokenAmount,this.toToken=n.state.toToken,this.myTokensWithBalance=n.state.myTokensWithBalance,this.popularTokens=n.state.popularTokens,this.searchValue="",this.unsubscribe.push(n.subscribe(e=>{this.sourceToken=e.sourceToken,this.toToken=e.toToken,this.myTokensWithBalance=e.myTokensWithBalance}))}updated(){var i,r;const t=(i=this.renderRoot)==null?void 0:i.querySelector(".suggested-tokens-container");t==null||t.addEventListener("scroll",this.handleSuggestedTokensScroll.bind(this));const e=(r=this.renderRoot)==null?void 0:r.querySelector(".tokens");e==null||e.addEventListener("scroll",this.handleTokenListScroll.bind(this))}disconnectedCallback(){var i,r;super.disconnectedCallback();const t=(i=this.renderRoot)==null?void 0:i.querySelector(".suggested-tokens-container"),e=(r=this.renderRoot)==null?void 0:r.querySelector(".tokens");t==null||t.removeEventListener("scroll",this.handleSuggestedTokensScroll.bind(this)),e==null||e.removeEventListener("scroll",this.handleTokenListScroll.bind(this)),clearInterval(this.interval)}render(){return u`
      <wui-flex flexDirection="column" gap="s">
        ${this.templateSearchInput()} ${this.templateSuggestedTokens()} ${this.templateTokens()}
      </wui-flex>
    `}onSelectToken(t){this.targetToken==="sourceToken"?n.setSourceToken(t):(n.setToToken(t),this.sourceToken&&this.sourceTokenAmount&&n.swapTokens()),$.goBack()}templateSearchInput(){return u`
    ...
    `}templateTokens(){const t=this.myTokensWithBalance?Object.values(this.myTokensWithBalance):[],e=this.popularTokens?this.popularTokens:[],i=this.filterTokensWithText(t,this.searchValue),r=this.filterTokensWithText(e,this.searchValue);return u`
      <wui-flex class="tokens-container">
        <wui-flex class="tokens" .padding=${["0","s","s","s"]} flexDirection="column">
          ${(i==null?void 0:i.length)>0?u`
                ...
                ${i.map(o=>{var c,y,k;const a=o.symbol===((c=this.sourceToken)==null?void 0:c.symbol)||o.symbol===((y=this.toToken)==null?void 0:y.symbol);return u`
                    <wui-token-list-item
